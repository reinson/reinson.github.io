...
projects.ehifBudget = {
    ...
    description: "The goal of this project was to give an overview of the budget of Estonian Health Insurance Fund. It shows data about both income and expense sides of the budget. It includes an interactive treemap visualization of expense hierarchy that I am quite pleased with."
};
...
projects.election = {
    ...
    description: "Estonia is one of the first countries to use E-voting (over the internet voting) for general election. This D3.js based interactive bubble chart shows the profile of a typical electronic voter by allowing the viewer to explore how the fraction of electronic votes depends on different characteristics of candidates."
};
